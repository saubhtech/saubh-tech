      ...
      <nav className="nav">
        <div className="nav-inner">
          ...
          <div className="nav-links">
            ...
            <Link href={`/${locale}/language`} style={{ color: 'var(--green-light)' }}>
          ...
          {loading ? (
            ...
            <div className="lang-grid">
              ...
              <div className="lang-card lang-card-live" style={{ opacity: 0.6, cursor: 'default' }}>
                ...
                <div className="lang-card-meta">{totalKeys}/{totalKeys} keys &bull; Direct</div>
              </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="lang-card-meta">
                      {lang.keys}/{lang.total} keys &bull; {lang.engine === 'indictrans2' ? 'IndicTrans2' : 'NLLB'}
                    </div>
                  </div>
                );
              })}
