...
-- RenameIndex
ALTER INDEX "idx_bid_requirid" RENAME TO "bid_requirid_idx";

-- RenameIndex
ALTER INDEX "idx_bid_userid" RENAME TO "bid_userid_idx";

-- RenameIndex
ALTER INDEX "idx_offerings_marketid" RENAME TO "offerings_marketid_idx";

-- RenameIndex
ALTER INDEX "idx_offerings_userid" RENAME TO "offerings_userid_idx";

-- RenameIndex
ALTER INDEX "idx_requirements_marketid" RENAME TO "requirements_marketid_idx";

-- RenameIndex
ALTER INDEX "idx_requirements_userid" RENAME TO "requirements_userid_idx";
